    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl ${color} bg-opacity-10 shadow-sm`}>
                ...
                <div className="flex items-center text-sm font-semibold group-hover:text-violet-600">
        ...
        const fetchUser = async () => {
            try {
                const response = await axios.get(
                    'https://careerflip.onrender.com/api/user/getuser',
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-gray-900 to-gray-800 p-8 text-white shadow-lg">
                <div className="relative z-10 max-w-2xl">
                    ...
                    <p className="text-gray-300 mb-6">
                        Connect with peers, mentors, and industry experts. Share progress, ask doubts,
                        collaborate, and grow together.
                    </p>

                    <button
                        onClick={() => navigate('/community')}
                        className="px-6 py-2.5 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                    >
                        Explore Community
                    </button>
                </div>
                ...
                <div className="absolute bottom-0 right-20 -mb-10 h-32 w-32 rounded-full bg-pink-500 opacity-20 blur-xl"></div>
            </div>
        </div>
    );
};
