# CareerFlip
---
⚠️ Important: Google OAuth Verification Limitation
...
✅ The Schedule feature works only when logged in via Google OAuth.
---
🔐 Final Note
